...
describe('DELETE /todos/:id', () => {
    it('should remove a TODO', (done) => {
        ...
        request(app)
            ...
            .expect(200)
            .expect((res)=> {
                expect(res.body.todo.text).toBe(todos[1].text); //res.body.todo._id = hexID
            })
            .end((err,res) => {
                if(err)
                {
                ...
                Todo.findById(hexID).then((todo) => {
                    expect(todo).toBeNull(); //toNotExist() doesnt work
                    done();
                }).catch((e) => done(e));
            });
    });
...
describe('PATCH /todos/:id', () => {
    it('should update the todo', (done) => {
        ...
        var text = 'This is new inserted text';
